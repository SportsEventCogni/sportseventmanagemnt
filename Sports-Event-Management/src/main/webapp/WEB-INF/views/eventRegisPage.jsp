	...
	<div class="signup-form">
		<form:form action="eventRegister" method="post" modelAttribute="event">
			<h2>Make Your Event</h2>
					...
					<form:errors class="event" path="eventId"></form:errors>
					...
					<form:errors class="event" path="eventName"></form:errors>
					...
					<form:errors class="event" path="sportsName"></form:errors>
					...
					<form:errors class="event" path="Date"></form:errors>
					...
					<form:errors class="event" path="time"></form:errors>
					...
					<form:errors class="event" path="venue"></form:errors>
					...
					<form:errors class="event" path="noOfSlots"></form:errors>
